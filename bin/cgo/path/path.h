...
extern __declspec(dllexport) struct _path_match_return _path_match(char *pattern, char *name);
...
extern __declspec(dllexport) struct _path_split_return _path_split(char *path);
